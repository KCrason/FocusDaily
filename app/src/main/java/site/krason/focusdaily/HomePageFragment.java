...
public class HomePageFragment extends Fragment
    ...
    protected void initViews(View view) {
        ...
        kFragmentPagerAdapter = new KFragmentPagerAdapter(getChildFragmentManager());
    ...
    private List<Fragment> getFragments() {
        ...
        channelBeanList.addAll(JSON.parseArray(ACache.get(getActivity()).getAsString(Constants.MY_CHANNEL_LIST), ChannelBean.class));
    ...
    private List<String> getTitles() {
        List<ChannelBean> channelBeanList = JSON.parseArray(ACache.get(getActivity()).getAsString(Constants.MY_CHANNEL_LIST), ChannelBean.class);
    ...
    private void setData() {
        String isExistLocalData = ACache.get(getActivity()).getAsString(Constants.IS_EXIST_LOCAL_DATA);
        if (TextUtils.isEmpty(isExistLocalData)) {
            ...
            ACache.get(getActivity()).put(Constants.MY_CHANNEL_LIST, JSON.toJSONString(mMyIDragEntities));
            ...
            ACache.get(getActivity()).put(Constants.RECOMMEND_CHANNEL_LIST, JSON.toJSONString(mRecommendIDragEntities));
            ACache.get(getActivity()).put(Constants.IS_EXIST_LOCAL_DATA, "TRUE");
        }
    }
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.img_add:
                ChannelEditorActivity.actionStart(getActivity());
                break;
        }
    }
