...
public class HandPickAdapter extends RecyclerView.Adapter<HandPickAdapter.HandPickViewHolder> {
    ...
    public HandPickViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(mContext).inflate(R.layout.item_recycler_handpick, parent, false);
